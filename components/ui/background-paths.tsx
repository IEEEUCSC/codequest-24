...
import HeroBgImage from "../Hero/HeroBg";
import { HeroSecHeader } from "../Hero/HeroText";
        ...
        <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-neutral-950">
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6 text-center">
                <motion.div
                    ...
                    className="max-w-4xl mx-auto flex flex-col items-center justify-center gap-y-3 lg:gap-y-8"
                >
                    <HeroSecHeader />
          <Image
            src={HeroLogo}
            ...
            priority={true}
          />
          <p className="text-center text-xs text-white text-balance lg:max-w-[65ch] lg:text-base">
