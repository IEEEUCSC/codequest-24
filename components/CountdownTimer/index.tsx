...
export function CountdownTimer({ targetDate, title }: CountdownTimerProps) {
  ...
  return (
    <div className="mx-auto w-full max-w-xl rounded-xl bg-transparent glow-shadow  border-primary-200 border-4 px-6 py-2 text-center">
      <h2 className="font-consola mb-4 text-2xl">{title}</h2>
...
function TimeUnit({ value, label }: { value: number; label: string }) {
  ...
  return (
    <div className="flex flex-col items-center">
      <span className="font-consola text-4xl font-bold tabular-nums">
        {formattedValue}
      </span>
